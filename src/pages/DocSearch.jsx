...
export function DocSearch() {
    ...
    async function getDoctors() {
        try {
            ...
            if (errorGetDoc.data.status == null) {
            ...
            <section className='py-8 UnderLineBetweenSection position-relative'>
                <div className='container'>
                    <div className='flex flex-row flex-wrap justify-content-evenly justify-content-center align-items-center text-center'>
                        ...
                        {showResult == null ? <div className="alert alert-danger text-center text-lg-center">not found</div> :<div className="d-flex justify-content-center flex-wrap gap-3 overflow-scroll w-100 searchSection position-relative"> {showResult.map((element, i) => <div key={i} className=' w-25 mt-4 text-right p-4 border-3 border-success rounded-4'>
