  ...
  return (
    <section className="lg:h-screen  flex justify-between items-center max-lg:flex-col gap-10 w-full p-8  max-container">
      <div className="flex flex-1 justify-center items-center">
        <img src={aboutImage} alt="about-us" className="shadow-lg rounded-lg" />
      </div>

      <div className="flex flex-1 flex-col items-end text-right ">
        <div className="flex items-center gap-1">
          <h2 className="text-[35px] md:text-[45px] font-bold text-[#056558] lg:max-w-lg">
            معلومات عنا
          </h2>
          <img src={info} className="w-[30px]" />
        </div>
        <h3 className="text-[22px] md:text-[28px] text-black lg:max-w-lg mt-3">
