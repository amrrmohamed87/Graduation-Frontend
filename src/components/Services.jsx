  ...
  return (
    <section className="lg:h-screen bg-white rounded-[30px] flex justify-between items-center max-lg:flex-col gap-10 w-full p-8  max-container mb-16">
      <div className="flex flex-1 flex-col items-end text-right">
        <h2 className=" text-[45px] font-bold mb-1 text-[#056558] lg:max-w-lg">
          الخدمات
        </h2>
        <h3 className="text-[28px] text-black lg:max-w-lg">
          المعجزة ليست أننا نقوم بهذا العمل، ولكننا سعداء للقيام بذلك
        </h3>
        <div className="bg-white shadow-2xl px-4 py-2 flex items-start gap-2 mt-4 mb-4">
